...
def _draw_titles(banner, colors) -> None:
    ...
    None
    """
    banner.text("SMART PARKING BARRIER", 4,
    ...
    banner.text("-=[ AVAILABILITY LAB ]=-", 3, colors["dim"],
                banner.W // 2, 660)
...
def _draw_features(banner, colors) -> None:
    ...
    None
    """
    banner.text("BOOM BARRIER   MANUAL RAISE", 5, colors["cyan"],
                banner.W // 2, 750)
    banner.text("IR REMOTE  DHT11 SENSOR", 4, colors["silver"],
                banner.W // 2, 900)
    banner.text("TOWER LIGHT  FAIL SAFE", 3, colors["silver"],
                banner.W // 2, 990)
    banner.text("XCHACHA20-POLY1305  ARGON2ID", 4, colors["dim"],
                banner.W // 2, 1120)
    banner.text("RANSOM LOCK", 4, colors["gold"],
                banner.W // 2, 1260)
    banner.text("AVAILABILITY  ANTI-DEBUG", 4, colors["gold"],
                banner.W // 2, 1350)
